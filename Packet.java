...
/// packet is an OBD object that carries data between the logic layer (primarily turn manager) and the view layer. Later it will be used to carry data to UI/Visualization layerws
public class Packet{
